...
Reducer<AuthState> authReducer = combineReducers<AuthState>(<Reducer<AuthState>>[
  ...
  TypedReducer<AuthState, GetCurrentUserLocationSuccessful>(_getCurrentUserLocationSuccessful),
]);
...
AuthState _getCurrentUserLocationSuccessful(AuthState state, GetCurrentUserLocationSuccessful action) {
